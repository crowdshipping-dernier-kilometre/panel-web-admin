        ...
        <div className="container-fluid">
                            ...
                            <div className="row g-0 align-items-center">
                                <div className="col me-2">
                                    <div className="text-uppercase text-primary fw-bold text-xs mb-1">
                                        <span>Nombre de camion en service</span>
                                    </div>
                                    <div className="text-dark fw-bold h5 mb-0"><span>5</span></div>
                                </div>
                            ...
                            <div className="row g-0 align-items-center">
                                <div className="col me-2">
                                    <div className="text-uppercase text-success fw-bold text-xs mb-1">
                                        <span>Bénéfice de la journée</span>
                                    </div>
                            ...
                            <div className="row g-0 align-items-center">
                                <div className="col me-2">
                                    <div className="text-uppercase text-warning fw-bold text-xs mb-1">
                                        <span>Livraison en attente de validation</span>
                                    </div>
            ...
            <div className="row">
                <div className="col-lg-7 col-xl-8">
                    <div className="card shadow mb-4">
                        <div className="card-header d-flex justify-content-between align-items-center">
                            <h6 className="text-primary fw-bold m-0">Historique des bénéfice</h6>
                ...
                <div className="col-lg-5 col-xl-4">
                    <div className="card shadow mb-4">
                        <div className="card-header d-flex justify-content-between align-items-center">
                            <h6 className="text-primary fw-bold m-0">Etats des colis</h6>
                            <div className="dropdown no-arrow">
                                <button className="btn btn-link btn-sm dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button">
                                    <i className="fas fa-ellipsis-v text-gray-400"></i>
                                </button>
                        ...
                        <div className="card-body">
                            ...
                            <div className="text-center small mt-4">
                                ...
                                <span className="me-2"><i className="fas fa-circle text-success"></i>&nbsp;en attente</span>
                                <span className="me-2"><i className="fas fa-circle text-info"></i>&nbsp;problème</span>
                            </div>
                        </div>
                    </div>
                </div>
